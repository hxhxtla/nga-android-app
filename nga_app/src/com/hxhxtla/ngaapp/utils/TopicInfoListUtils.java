...
public class TopicInfoListUtils {
	...
	public static List<TopicInfo> initializeTopicInfoList(
	...
	public static List<TopicInfo> initializeAllTopicInfoList(
			List<TopicInfo> AllTopicInfoList) {
		if (AllTopicInfoList == null) {
			AllTopicInfoList = new ArrayList<TopicInfo>();
		}
		...
		AllTopicInfoList.add(new TopicInfo(R.string.topic68_id,
				R.string.topic68, R.drawable.p390));
		...
		AllTopicInfoList.add(new TopicInfo(R.string.topic62_id,
				R.string.topic62, R.drawable.p29));
